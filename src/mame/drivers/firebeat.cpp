...
static INPUT_PORTS_START(bm3)
	...
	PORT_BIT( 0x2ff, 0x00, IPT_PADDLE ) PORT_PLAYER(1) PORT_NAME("1P Table (Analog)") PORT_MINMAX(0x00,0x2ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(25)

	PORT_START( "TURNTABLE_P1_DIGITAL" )
	PORT_BIT( 0x2ff, 0x00, IPT_DIAL ) PORT_PLAYER(1) PORT_NAME("1P Table (Digital)") PORT_MINMAX(0x00,0x2ff) PORT_SENSITIVITY(75) PORT_KEYDELTA(25)

	PORT_START( "TURNTABLE_P2_ANALOG" )
	PORT_BIT( 0x2ff, 0x00, IPT_PADDLE ) PORT_PLAYER(2) PORT_NAME("2P Table (Analog)") PORT_MINMAX(0x00,0x2ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(25)

	PORT_START( "TURNTABLE_P2_DIGITAL" )
	PORT_BIT( 0x2ff, 0x00, IPT_DIAL ) PORT_PLAYER(2) PORT_NAME("2P Table (Digital)") PORT_MINMAX(0x00,0x2ff) PORT_SENSITIVITY(75) PORT_KEYDELTA(25)
