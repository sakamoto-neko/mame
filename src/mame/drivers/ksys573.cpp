...
static INPUT_PORTS_START( gtrfrks )
	...
	PORT_MODIFY( "IN2" )
	PORT_BIT( 0x00000300, 0x0000, IPT_DIAL) PORT_NAME("P1 Effect Knob") PORT_MINMAX(0x0000, 0x0300) PORT_SENSITIVITY(1) PORT_KEYDELTA(8) PORT_INVERT
	...
	PORT_BIT( 0x00000003, 0x0000, IPT_DIAL) PORT_NAME("P2 Effect Knob") PORT_MINMAX(0x00, 0x03) PORT_SENSITIVITY(1) PORT_KEYDELTA(8) PORT_INVERT
